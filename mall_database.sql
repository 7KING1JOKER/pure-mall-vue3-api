...
VALUES (10001, 'admin', 'admin123', 'admin@example.com', '13800138000', 1),
(10002, 'user', 'user123', 'user@example.com', '13800138001', 1)
ON DUPLICATE KEY UPDATE password = 'admin123';

-- 插入商品数据（基于前端data.txt）
-- 商品基础信息插入，匹配完整表结构
INSERT INTO products (id, name, brief, price, originalPrice, sales, stock, status, categoryLabel) VALUES
...
-- 为部分商品添加规格信息
INSERT INTO product_specs (productId, name, price, stock, color, size) VALUES
-- 商品1的规格 (所有商品的默认规格)
(1, '', 50, 100, '白色', 'S'),
(1, '', 60, 80, '白色', 'M'),
(1, '', 70, 90, '白色', 'L'),
